function [newVelocity, newBrakeTemperature] = Truck(gear, pedalPressure, slopeAngle, velocity, temperature, timeStep)
  truckMass = 20000;
  g = 9.8;
  Ch = 40;
  tau = 30;
  ...
  newVelocity = velocity + (1/truckMass)*(gravityForce - foundationBrakeForce - engineBrakeForce)*timeStep;
  ...
  newBrakeTemperature =  deltaTemperature + ambientTemperature;
